...
/**
 * Given a list of topic terms, extracts the ratio of topic terms to all terms in student utterances only.
 * 
 * @author Tahir Sousa
 * @version last updated: Apr 03, 2014 [Sousa]
 */
public class StudentDictionaryFeatureExtractor
...
implements DocumentFeatureExtractor
{
	...
	@ConfigurationParameter(name = PARAM_DICTIONARY_NAME, mandatory = true, defaultValue = "LIWC_S_")
	...
	public static final String POSITIVITY_PER_CONV = "PositivityPerConv_S";
	public static final String NEGATIVITY_PER_CONV = "NegativityPerConv_S";
	public static final String POSITIVITY_NEGATIVITY_PER_CONV = "PositivityNegativityPerConv_S";
	public static final String NEGATIVE_IMP_PER_CONV = "NegativeImperativePerConv_S";
	public static final String POSITIVE_NEGATIVE_IMP_PER_CONV = "NonNegativeImperativePerConv_S";
	public static final String POSITIVE_IMP_PER_CONV = "PositiveImperativePerConv_S";

	private static final String GROUP_PREFIX = "SE_Dic__";
	...
	// TODO: not adapted for focus annotations
		...
		while( iterator.hasNext())
		{
			...
			featList.addAll( Arrays.asList(new Feature(GROUP_PREFIX+ prefix + "_" + listname,
					numTokensInDoc > 0 ? (wordcount / numTokensInDoc) : 0)));
		}              	 

		featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ POSITIVITY_PER_CONV, positiveScore / nrConversations)));
		featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ NEGATIVITY_PER_CONV, negativeScore / nrConversations)));
		featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ POSITIVITY_NEGATIVITY_PER_CONV, positiveNegativeScore / nrConversations)));
		featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ NEGATIVE_IMP_PER_CONV, negativeImperativeScore / nrConversations)));
		featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ POSITIVE_IMP_PER_CONV, positiveImperativeScore / nrConversations)));
		featList.addAll(Arrays.asList(new Feature(GROUP_PREFIX+ POSITIVE_NEGATIVE_IMP_PER_CONV, positiveNegativeImperativeScore / nrConversations)));
		
		return featList;
	}

	/**
	 * Log sentence context of a feature 
	 * @param fileName file name to be written to
	 * @param newContent content to be written to file
	 * @param appendToFile appendToFile?
	 */
