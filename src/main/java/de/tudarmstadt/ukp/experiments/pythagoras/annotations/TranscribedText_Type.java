...
/**
 * Contains all classroom utterances in an annotation called TranscribedText
 * This is the type file of {@link TranscribedText} annotation
 * Adopted from previous work
 * @version last updated: Apr 03, 2014 [Sousa]
 */
public class TranscribedText_Type extends Annotation_Type {
  /** @generated */
  @Override
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (TranscribedText_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = TranscribedText_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new TranscribedText(addr, TranscribedText_Type.this);
  			   TranscribedText_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new TranscribedText(addr, TranscribedText_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = TranscribedText.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("pythagoras.annotations.TranscribedText");
  ...
  public long getTimeStamp(int addr) {
      ...
      jcas.throwFeatMissing("timeStamp", "pythagoras.annotations.TranscribedText");
  ...
  public String getSpeaker(int addr) {
      ...
      jcas.throwFeatMissing("speaker", "pythagoras.annotations.TranscribedText");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public TranscribedText_Type(JCas jcas, Type casType) {
    super(jcas, casType);
